...
export default function Card({ title, price, image }: Book): JSX.Element
{
  return (
    <>
      <div className=" w-40 md:w-52 h-80 md:h-[24rem] p-4 flex flex-col justify-between items-center cursor-pointer rounded-md hover:bg-light-grey active:scale-95 transition-all duration-300">
        <Image
          src={ image }
          alt={ title }
          draggable="false"
