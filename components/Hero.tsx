    ...
    <>
      <div className=" w-full grid grid-cols-1 md:grid-cols-3">
        ...
        <div className=" min-h-[20rem] p-6 col-span-1 order-1 md:order-2 flex flex-col justify-center items-center md:bg-light-grey">
          ...
          <h1 className=" my-2 text-justify text-xl font-medium font-epilogue">
            Welcome to Book Worm, your one-stop destination for a world of knowledge and spiritual enrichment.
          </h1>

          <h2 className=" my-2 text-justify text-sm font-epilogue">
          ...
          <div className=" w-full my-2 flex justify-center items-center">
            <button className=" w-36 h-12 rounded-lg text-sm font-epilogue bg-light-grey md:bg-white scale">
              Visit Store
            </button>
          </div>
